...
public:
  ...
  RunnerService(InstanceRegistryControlSource &registry, ProfileCatalogAccess &catalog, RemminaLaunchSource &launcher,
                QObject *parent = nullptr);
  RunnerService(InstanceRegistryControlSource &registry, ProfileCatalogAccess &catalog, RemminaLaunchSource &launcher,
                std::chrono::milliseconds catalogIdleTimeout, QObject *parent = nullptr);
