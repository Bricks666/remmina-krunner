...
public:
  ...
  RemminaRunnerConfig(InstanceSettingsModel &model, QWidget *parent, const KPluginMetaData &data);
...
private:
  ...
  explicit RemminaRunnerConfig(std::unique_ptr<ProductionDependencies> dependencies, QWidget *parent,
