...
KConfigSelectionStore::KConfigSelectionStore() : configFile_(QStringLiteral("remmina-krunnerrc")) {}

KConfigSelectionStore::KConfigSelectionStore(QString filePath) : configFile_(std::move(filePath)) {}
