...
{
    const RemminaInstance duplicated = native(QStringLiteral("opaque-duplicate"),
                                              QStringLiteral("/opt/remmina"));
    FakeRegistry registry;
...
void InstanceSettingsModelTest::preservesPartialErrorsAndHandlesEmptyOrThrowingScans()
{
    ...
    partial.rescans = {{{native()}, QStringLiteral("native:/usr/bin/remmina"),
    ...
    QCOMPARE(partialModel.failedBackends(),
...
void InstanceSettingsModelTest::defaultsUsePriorityAndInputOrderWithoutWriting()
{
    ...
    registry.rescans = {{
        {snap(),
         native(QStringLiteral("native:first"), QStringLiteral("/first/remmina")),
         native(QStringLiteral("native:second"), QStringLiteral("/second/remmina")),
         flatpak()},
        QStringLiteral("snap:remmina"),
        {},
    }};
