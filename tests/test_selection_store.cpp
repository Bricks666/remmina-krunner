...
void SelectionStoreTest::reportsSyncFailure()
{
    ...
    const QFileDevice::Permissions readOnlyDirectory = QFileDevice::ReadOwner
    ...
    QVERIFY(QFile::setPermissions(blockedDirectory,
                                  readOnlyDirectory | QFileDevice::WriteOwner));
}
