...
ProfileRecord makeRecord(QString opaqueId, QString name, QString server, QStringList labels = {}) {
  return {
...
void MatcherTest::handlesUnicodeWhitespaceAndCaseFolding() {
  ...
  QCOMPARE(lookup.tokens, QStringList({QStringLiteral("stra\u00dfe"), QStringLiteral("z\u00fcrich")}));
...
void MatcherTest::rejectsNonStandaloneTrigger() {
  const QList<QString> queries{
      QStringLiteral("remote"),   QStringLiteral("remote host"), QStringLiteral("rem:host"),
      QStringLiteral("rem-host"), QStringLiteral("xrem host"),   QStringLiteral(" rem host"),
  };
...
void MatcherTest::matchesUnicodeCaseFoldEquivalents() {
  const QList<ProfileRecord> profiles{
      makeRecord(QStringLiteral("sigma"), QStringLiteral("\u03c2"), QStringLiteral("sigma.example.com")),
  };
...
void MatcherTest::matchesOnlyVisibleProfileFields() {
  ProfileRecord profile = makeRecord(QStringLiteral("opaque-secret"), QStringLiteral("Stra\u00dfe Office"),
                                     QStringLiteral("visible.example.com"), {QStringLiteral("Production")});
  ...
  const QList<SearchMatch> nameMatches = matchProfiles(profiles, {QStringLiteral("stra\u00dfe")});
  ...
  const QList<SearchMatch> labelMatches = matchProfiles(profiles, {QStringLiteral("production")});
  ...
  const QStringList hiddenQueries{
      QStringLiteral("rdp-secret"),    QStringLiteral("alice"),         QStringLiteral("source-secret"),
      QStringLiteral("launch-secret"), QStringLiteral("opaque-secret"), QStringLiteral("display-secret"),
  };
...
void MatcherTest::matchesSupportedServerForms() {
  const QList<ProfileRecord> profiles{
      makeRecord(QStringLiteral("ipv4"), QStringLiteral("IPv4 host"), QStringLiteral("192.0.2.10")),
      makeRecord(QStringLiteral("ipv6"), QStringLiteral("IPv6 host"), QStringLiteral("[2001:db8::42]")),
      makeRecord(QStringLiteral("hostname"), QStringLiteral("Domain host"), QStringLiteral("bastion.example.com")),
      makeRecord(QStringLiteral("port"), QStringLiteral("Port host"), QStringLiteral("rdp.example.com:3389")),
  };
...
void MatcherTest::requiresEveryTokenAcrossVisibleFields() {
  const QList<ProfileRecord> profiles{
      makeRecord(QStringLiteral("split"), QStringLiteral("finance"), QStringLiteral("10.1.2.3"),
                 {QStringLiteral("urgent")}),
  };

  const QList<SearchMatch> matches =
      matchProfiles(profiles, {QStringLiteral("finance"), QStringLiteral("10.1.2.3"), QStringLiteral("urgent")});
  QCOMPARE(matches.size(), 1);
  QCOMPARE(matches.constFirst().record.opaqueId, QStringLiteral("split"));
  QCOMPARE(matches.constFirst().relevance, 1.00);

  QVERIFY(matchProfiles(profiles, {QStringLiteral("finance"), QStringLiteral("missing")}).isEmpty());
}

void MatcherTest::ranksBestRelationshipAndWeakestToken() {
  const QList<ProfileRecord> profiles{
      makeRecord(QStringLiteral("substring"), QStringLiteral("xalphax"), QStringLiteral("host"),
                 {QStringLiteral("xbetax")}),
      makeRecord(QStringLiteral("prefix"), QStringLiteral("alphabet"), QStringLiteral("host"),
                 {QStringLiteral("betamax")}),
      makeRecord(QStringLiteral("exact"), QStringLiteral("alpha"), QStringLiteral("host"), {QStringLiteral("beta")}),
      makeRecord(QStringLiteral("best-field"), QStringLiteral("alpha suffix"), QStringLiteral("alpha"),
                 {QStringLiteral("beta")}),
  };

  const QList<SearchMatch> matches = matchProfiles(profiles, {QStringLiteral("alpha"), QStringLiteral("beta")});
...
void MatcherTest::usesWeakestMixedTokenRelationship() {
  const QList<ProfileRecord> profiles{
      makeRecord(QStringLiteral("substring-weakest"), QStringLiteral("alpha"), QStringLiteral("host"),
                 {QStringLiteral("xbetax")}),
      makeRecord(QStringLiteral("prefix-weakest"), QStringLiteral("alpha"), QStringLiteral("host"),
                 {QStringLiteral("betamax")}),
  };
...
void MatcherTest::sortsTiesByFoldedVisibleMetadataAndSourcePath() {
  ProfileRecord sourceB = makeRecord(QStringLiteral("source-b"), QStringLiteral("Alpha"), QStringLiteral("SAME"),
                                     {QStringLiteral("needle")});
  sourceB.sourcePath = QStringLiteral("/b.remmina");
  ProfileRecord sourceA = makeRecord(QStringLiteral("source-a"), QStringLiteral("aLPHA"), QStringLiteral("same"),
                                     {QStringLiteral("needle")});
  sourceA.sourcePath = QStringLiteral("/a.remmina");
  ProfileRecord serverBeta = makeRecord(QStringLiteral("server-beta"), QStringLiteral("ALPHA"), QStringLiteral("Beta"),
                                        {QStringLiteral("needle")});
  serverBeta.sourcePath = QStringLiteral("/z.remmina");
  ProfileRecord nameBeta =
      makeRecord(QStringLiteral("name-beta"), QStringLiteral("Beta"), QStringLiteral("a"), {QStringLiteral("needle")});
...
void MatcherTest::doesNotMutateInput() {
  QList<ProfileRecord> profiles{
      makeRecord(QStringLiteral("second"), QStringLiteral("Zulu"), QStringLiteral("z.example"),
                 {QStringLiteral("shared")}),
      makeRecord(QStringLiteral("first"), QStringLiteral("Alpha"), QStringLiteral("a.example"),
                 {QStringLiteral("shared")}),
  };
